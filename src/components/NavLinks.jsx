...
const NavLinks = () => {
  ...
  const renderSubMenu = (menu) => {
    if (activeMenu === menu) {
      return (
        <ul onMouseLeave={handleMenuMouseLeave}>
          <li>
            <Link to="/submenu-option-1" onClick={handleSubMenuClick}>
              CONNEX Inbound Materials
            </Link>
          </li>
          {/* <li>
            <Link to="/submenu-option-2" onClick={handleSubMenuClick}>
              Submenu Option 2
            </Link>
          </li> */}
        </ul>
                ...
                <div className="absolute top-20 hidden group-hover:md:block hover:md:block">
                  ...
                  <div className="bg-white p-5 grid grid-cols-3 gap-10">
                    {link.sublinks.map((mysublinks) => (
                      <div>
                        {/* READY MIX PRODUCER AND OTHER HEADINGS */}
                        ...
                        {mysublinks.sublink.map((slink) => (
                          <li
                            ...
                            className="text-xs text-gray-600 my-2"
                          >
                            {showSubMenu && (
                          <ul>
                            <li
