      ...
      <div class="container mx-auto my-4">
        <div class="owl-carousel owl-theme">
          <div class="bg-gray-100 rounded-lg shadow-lg p-4">
            ...
            <h2 class="text-xl font-semibold text-gray-700 mb-2">Heading 1</h2>
          ...
          <div class="bg-gray-100 rounded-lg shadow-lg p-4">
            ...
            <h2 class="text-xl font-semibold text-gray-700 mb-2">Heading 2</h2>
            <p class="text-gray-600">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
          ...
          <div class="bg-gray-100 rounded-lg shadow-lg p-4">
            ...
            <h2 class="text-xl font-semibold text-gray-700 mb-2">Heading 3</h2>
            <p class="text-gray-600">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
